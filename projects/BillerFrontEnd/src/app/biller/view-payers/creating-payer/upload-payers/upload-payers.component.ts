...
import { utils, write, WorkBook, readFile, read } from 'xlsx';
import { ExcelDataService } from '../../../services/excel-data.service';
@Component({
  selector: 'app-upload-payers',
  templateUrl: './upload-payers.component.html',
  styleUrls: ['./upload-payers.component.css']
})
export class UploadPayersComponent implements OnInit {
  uploadedFiles: any[] = [];
  selected_file = [];
  file_name;
  fileName: any;
  ...
  downloadSample() {
    this.excelData. billerpayerSampleExcel('Payer Sample', this.localData);
