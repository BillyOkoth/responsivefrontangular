...
@Component({
  selector: 'app-upload-map-invoice',
  templateUrl: './upload-map-invoice.component.html',
  styleUrls: ['./upload-map-invoice.component.css']
})
export class UploadMapInvoiceComponent implements OnInit {
  selected_file = [];
  fileList: any = [];
  uploading = false;
  fileName;
  ...
  getJson(value) {
    ...
    this.billerService.invoice_columns = this.columns;
