...
function parsePhoneNumber(formattedPhoneNumber, defaultCountry, metadata) {
	...
	// then `number` is defined and `countryCallingCode` isn't.
			...
			countryCallingCode = (0, _getCountryCallingCode2.default)(defaultCountry, metadata.metadata);
		} else return {};
...
function parseNationalNumber(number, metadata) {
	var nationalNumber = (0, _parseIncompletePhoneNumber2.default)(number);
	var carrierCode = void 0;
	...
	if (metadata.possibleLengths()) {
		...
		switch ((0, _getNumberType_.checkNumberLengthForType)(potentialNationalNumber, undefined, metadata)) {
			case 'TOO_SHORT':
		...
		// like `8` is the national prefix for Russia and both
		// `8 800 555 35 35` and `800 555 35 35` are valid numbers.
		if ((0, _util.matchesEntirely)(nationalNumber, metadata.nationalNumberPattern()) && !(0, _util.matchesEntirely)(potentialNationalNumber, metadata.nationalNumberPattern())) {
