...
ScrollToAnimation = /** @class */ (function () {
    ...
    function ScrollToAnimation(_container, _listenerTarget, _isWindow, _to, _options, _isBrowser) {
        ...
        if (this._isBrowser) {
             ...
             * @return {?}
             */
            function (value, key) { return _this._mappedOffset = window.innerWidth > key ? value : _this._mappedOffset; }));
        }
...
var ScrollToService = /** @class */ (function () {
    ...
    function (options) {
         ...
         * @return {?}
         */
        function () { return _this._animation.stop(); });
    ...
    function (listenerTarget, handler) {
         ...
         * @return {?}
         */
        function (event) { return listenerTarget
