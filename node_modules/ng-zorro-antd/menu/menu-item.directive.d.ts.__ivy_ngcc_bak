...
export declare class NzMenuItemDirective implements OnInit, OnChanges, OnDestroy, AfterContentInit {
    ...
    constructor(nzMenuService: MenuService, nzSubmenuService: NzSubmenuService, isMenuInsideDropDown: boolean, routerLink?: RouterLink | undefined, routerLinkWithHref?: RouterLinkWithHref | undefined, router?: Router | undefined);
    ngOnInit(): void;
